...
|---|---|---|
| Project and assets | Inspect the editor, scenes, exact asset metadata/data, safely create JSON/text assets, copy or move supported assets, and inspect dependencies, logs, and script diagnostics. | `get_project_info`, `inspect_asset`, `create_asset`, `copy_asset`, `move_asset`, `list_assets` |
