...
This fork has its own extension and package identity. The Funplay tools remain the starting point; the additional capabilities in the [requirements](./docs/REQUIREMENTS.md) are plans, not completed features. Editor behavior and saved assets still need validation in a test project.
...
Contribution and source-boundary rules are in [AGENTS.md](./AGENTS.md).
