...
test('full profile exposes all built-in tools', () => {
  ...
  assert.equal(tools.some((tool) => tool.name === 'query_asset_uuid'), true);
  assert.equal(tools.find((tool) => tool.name === 'query_asset_uuid').annotations.readOnlyHint, true);
  assert.equal(tools.some((tool) => tool.name === 'query_asset_url'), true);
  assert.equal(tools.find((tool) => tool.name === 'query_asset_url').annotations.readOnlyHint, true);
  ...
  assert.equal(tools.some((tool) => tool.name === 'save_asset'), true);
  assert.equal(tools.some((tool) => tool.name === 'reimport_asset'), true);
  assert.equal(tools.some((tool) => tool.name === 'import_asset'), true);
  assert.equal(tools.some((tool) => tool.name === 'import_folder'), true);
  assert.equal(tools.some((tool) => tool.name === 'refresh_asset'), true);
