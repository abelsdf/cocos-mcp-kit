...
| 领域 | 已提供的能力 | 示例工具 |
|---|---|---|
| 工程与资源 | 查询编辑器、场景、精确资源元数据/数据，安全创建或保存 JSON/文本资源、复制、移动或重导入受支持资源，并检查引用、日志和脚本诊断。 | `get_project_info`、`inspect_asset`、`create_asset`、`save_asset`、`copy_asset`、`move_asset`、`reimport_asset`、`list_assets` |
