...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 40 tools; the `full` profile exposes 134 tools.
...
| `full` | 134 | All built-in tools, including destructive and low-level helpers. |
