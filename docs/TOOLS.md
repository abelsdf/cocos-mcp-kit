...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 39 tools; the `full` profile exposes 118 tools.
...
| `full` | 118 | All built-in tools, including destructive and low-level helpers. |
