...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 39 tools; the `full` profile exposes 112 tools.
...
| `full` | 112 | All built-in tools, including destructive and low-level helpers. |
