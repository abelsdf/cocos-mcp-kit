...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 41 tools; the `full` profile exposes 137 tools.

## Profile Summary

| Profile | Tool Count | Purpose |
|---|---:|---|
| `core` | 41 | Focused default surface for common editor automation. |
| `full` | 137 | All built-in tools, including destructive and low-level helpers. |
