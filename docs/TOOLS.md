...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 40 tools; the `full` profile exposes 130 tools.
...
| `full` | 130 | All built-in tools, including destructive and low-level helpers. |
