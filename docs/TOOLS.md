...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 39 tools; the `full` profile exposes 116 tools.
...
| `full` | 116 | All built-in tools, including destructive and low-level helpers. |
