...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 39 tools; the `full` profile exposes 114 tools.
...
| `full` | 114 | All built-in tools, including destructive and low-level helpers. |
