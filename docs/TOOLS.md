...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 39 tools; the `full` profile exposes 119 tools.
...
| `full` | 119 | All built-in tools, including destructive and low-level helpers. |
